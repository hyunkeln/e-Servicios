...
/*REMOTE*/
var remote={ajax:function(service_url){var response=$.ajax({dataType:"jsonp",url:service_url,});return response;}};
...
jQuery(function($) {
    ...
    $.em = $.extend({
         ...
         * @desc The default action is to trigger a global â??emchangeâ? event.
        ...
        action: function() {
            ...
            if ( currentWidth != $.em.current ) {
                 ...
                 * the â??emchangeâ? event is triggered.
                 *
                 * @example $.em.previous;
                 * @result 16
                 *
